...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '知非', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '你好，我是知非', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ynwws.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '知非的博客', // 网站关键词 英文逗号隔开
  SINCE: process.env.NEXT_SINCE || 2024, // 建站年份
  
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'achangbq@gmail.com', // 邮箱地址 例如mail@tangly1024.com
